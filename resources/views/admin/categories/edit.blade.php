...
<div class="p-6 max-w-2xl mx-auto">
    ...
    <form action="{{ route('admin.categories.update', $category) }}" method="POST" class="bg-white rounded-lg shadow p-6 space-y-4">
        @csrf @method('PUT')
        <div>
        ...
        <div>
            ...
            <textarea name="description" rows="3" class="w-full border-gray-300 rounded">{{ $category->description }}</textarea>
        </div>
